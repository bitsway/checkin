...
function submit_data(){
	...
	if(errorFlag==1){
		...
		$.ajax({
			...
			success: function(result) {
						if (result!==''){
							if (imageFileID!=''){upload_image(imageFileID, imageFileName);}
							if (imageFileID2!=''){upload_image(imageFileID2, imageFileName1);}
							if (imageFileID3!=''){upload_image(imageFileID3, imageFileName2);}
